  ...
  const networkConfig = {
    ...
    zones: [
      ...
      },
      {
        ...
        http: 'http://127.0.0.1:9201',
        name: 'Zone-0-1',
        region: 0
      },
      // Region 2 zones
      {
        ws: 'ws://127.0.0.1:8220',
        http: 'http://127.0.0.1:9220',
        name: 'Zone-1-0',
        region: 1
      },
      {
        ws: 'ws://127.0.0.1:8221',
        http: 'http://127.0.0.1:9221',
        name: 'Zone-1-1',
        region: 1
      }
    ]
